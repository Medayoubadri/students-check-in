...
const BentoCard = ({
  ...
  <div
    ...
    {...props}
  >
    <div className={cn("h-full group-hover:blur-sm", backgroundClassName)}>
      {background}
    </div>
    <div className="bottom-0 z-10 absolute flex flex-col gap-1 p-6 transform-gpu transition-all group-hover:-translate-y-10 duration-300 pointer-events-none">
